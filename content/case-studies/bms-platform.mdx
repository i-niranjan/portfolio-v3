...
<CaseStudyImage
  src="/work/bms_2.png"
  alt="Book My Services platform"
  caption="The customer-facing booking experience — one of three applications in the platform"
/>
...
The platform launched in 2026 and is live at [bookmyservices.co.uk](https://bookmyservices.co.uk). The monorepo architecture delivered what it was designed to — a codebase where three applications could evolve in parallel without stepping on each other, and where shared logic stayed consistent across the entire product.
